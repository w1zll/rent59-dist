(() => {
    ...
    let apartmentThumbsSlider;
    let apartmentMainSlider;
    function initSliders() {
        ...
        if (document.querySelector(".thumb-apartment__slider")) apartmentThumbsSlider = new swiper_core_Swiper(".thumb-apartment__slider", {
        ...
        if (document.querySelector(".main-img-apartment__slider")) apartmentMainSlider = new swiper_core_Swiper(".main-img-apartment__slider", {
            ...
            navigation: {
                prevEl: ".thumb-apartment .swiper-button-prev",
                nextEl: ".thumb-apartment .swiper-button-next"
            },
            breakpoints: {
                320: {
                    pagination: {
